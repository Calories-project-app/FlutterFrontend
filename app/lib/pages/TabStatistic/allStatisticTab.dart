                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text(
                                      '${(foodHistory.calories)?.toStringAsFixed(2) ?? "N/A"}',
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                ...
                                Text(
                                  '${(foodHistory.protein)?.toStringAsFixed(2)} Grams',
                                  style: GoogleFonts.openSans(
                                      fontSize: 10,
                                      color: tertiaryColor,
                            ...
                            Column(
                              children: [
                                ...
                                Text(
                                  '${(foodHistory.carbohydrate)?.toStringAsFixed(2)} Grams',
                                  style: GoogleFonts.openSans(
                                      fontSize: 10,
                                      color: tertiaryColor,
                                      fontWeight: FontWeight.w400),
                            ...
                            Column(
                              children: [
                                ...
                                Text(
                                  '${(foodHistory.fat)?.toStringAsFixed(2)} Grams',
                                  style: GoogleFonts.openSans(
                                      fontSize: 10,
                                      color: tertiaryColor,
                                      fontWeight: FontWeight.w400),
